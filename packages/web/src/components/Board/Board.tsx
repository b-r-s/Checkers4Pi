...
import type { GameState, PlayerColorTheme } from '@ai-checkers/shared';
...
export const Board: React.FC<BoardProps> = ({ gameState, onTileClick, onMovePiece, onRestart, toastMessage, playerColor }) => {
