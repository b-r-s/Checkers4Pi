...
import './Sidebar.css';
import type { AILevel, Player, PlayerColorTheme, BoardColorTheme } from '@ai-checkers/shared';
import type { ScoreBreakdown, GameSettings } from '@ai-checkers/shared';
import { COLOR_THEME_LABELS, BOARD_THEME_LABELS, BOARD_COLOR_SCHEMES } from '@ai-checkers/shared';
